...
## status: superseded by \[[ADR-0004]\] date: 2026-06-21 decision-makers: "@RyosukeDTomita"

# ADR-0002: submissions API のページング方式

> **Note:** この ADR は [[ADR-0004]](%E5%8F%96%E5%BE%97%E6%9C%9F%E9%96%93%E3%81%A8%E5%8F%96%E5%BE%97%E6%96%B9%E5%BC%8F) によって置き換えられた。
...
1. 次の `from_second = 最後の提出の epoch_second`(同値) + 提出IDで重複除去
1. `from_second = 0` から全提出を取得(範囲を絞らない)
